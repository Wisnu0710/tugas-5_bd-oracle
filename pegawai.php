      ...
      <!--- tambah data -->
              <form class="form-horizontal" action="add.php" method="post">
               <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  <label for="">USIA PEGAWAI</label>
                  <input type="text" class="form-control" name="USIA_PEGAWAI" placeholder="USIA_PEGAWAI">
                </div>
                <div class="form-group col-md-6">
                  <label for="">JK</label>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
    include 'koneksi.php';
    $stid = oci_parse($con, 'SELECT * from PEGAWAI');
    ...
    while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
      ?>
                        <tr>                          
                          ...
                          <td class="td-actions">
              <a href="up_pegawai.php?id=<?= $d['ID_PEGAWAI'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
              <a href="del_pegawai.php?id=<?= $d['ID_PEGAWAI'] ?>" 
