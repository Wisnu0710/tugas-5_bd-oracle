              ...
              <form class="form-horizontal" action="add.php" method="post">
               <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="ID_OBAT" placeholder="ID_OBAT">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  <label for="">TGL KADARLUASA</label>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
    include 'koneksi.php';
    $stid = oci_parse($con, 'SELECT * from OBAT');
    ...
    while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
      ?>
                        <tr>                          
                          ...
                          <td class="td-actions">
              <a href="up_obat.php?id=<?= $d['ID_OBAT'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
              <a href="del_obat.php?id=<?= $d['ID_OBAT'] ?>" 
